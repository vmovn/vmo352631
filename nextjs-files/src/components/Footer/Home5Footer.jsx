                    ...
                    <div className="row">
                        <div className="col-lg-3">
                            <div className="company-logo-and-location-area">
                                <div className="company-logo-area">
                                    ...
                                    <a href="#" className="file-download-btn">
                                        <div className="icon">
                        ...
                        <div className="col-lg-9">
                            <div className="footer-contact-wrap">
                                ...
                                <a className="primary-btn5" href="https://www.google.com/maps">
                                    View Site Map
                                ...
                                <div className="row gy-5">
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6 d-flex justify-content-lg-center">
                                        <div className="footer-widget">
                                            ...
                                            <ul className="widget-list">
                                                <li><Link href="/service/details">Finance &amp; Fintech</Link></li>
                                                <li><Link href="/service/details">Healthcare &amp; Life</Link></li>
                                                <li><Link href="/service/details">Retail &amp; Ecommerce</Link></li>
                                                <li><Link href="/service/details">Government &amp; Public</Link></li>
                                                <li><Link href="/service/details">Travel &amp; Hospitality</Link></li>
                                            </ul>
                                        </div>
                                    </div>
