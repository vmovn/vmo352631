            ...
            <div className="container">
                ...
                <div className="blog-slider-area">
                                ...
                                <div className="swiper-wrapper">
                                    <SwiperSlide className="swiper-slide">
                                        <div className="blog-card2">
                                            <div className="row align-items-center g-xxl-4 g-xl-3 g-lg-2 g-md-4 g-sm-3 g-4">
                    ...
                    <div className="slider-btn-grp three">
                        <div style={{ cursor: "pointer" }} className="slider-btn blog-slider-prev">
                        ...
                        <div style={{ cursor: "pointer" }} className="slider-btn blog-slider-next">
                            <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                <g>
